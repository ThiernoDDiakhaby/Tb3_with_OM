...
class BoundingBox {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('Invalid')) {
        this.Invalid = initObj.Invalid
      }
      else {
        this.Invalid = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [Invalid]
    bufferOffset = _serializer.bool(obj.Invalid, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [Invalid]
    data.Invalid = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.Invalid !== undefined) {
      resolved.Invalid = msg.Invalid;
    }
    else {
      resolved.Invalid = false
    }

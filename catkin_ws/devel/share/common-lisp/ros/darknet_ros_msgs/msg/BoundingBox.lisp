...
(cl:ensure-generic-function 'Invalid-val :lambda-list '(m))
(cl:defmethod Invalid-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader darknet_ros_msgs-msg:Invalid-val is deprecated.  Use darknet_ros_msgs-msg:Invalid instead.")
  (Invalid m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <BoundingBox>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'Z))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'Invalid) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBox>) istream)
  "Deserializes a message object of type '<BoundingBox>"
    ...
    (cl:setf (cl:slot-value msg 'Invalid) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BoundingBox>)))
  ...
  "b7c471f7e43701288329c5fdd129b1f2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BoundingBox)))
  "Returns md5sum for a message object of type 'BoundingBox"
  "b7c471f7e43701288329c5fdd129b1f2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBox>)))
  ...
  (cl:format cl:nil "string Class~%float64 probability~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%float32 X~%float32 Y~%float32 Z~%bool Invalid~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBox)))
  "Returns full string definition for message of type 'BoundingBox"
  (cl:format cl:nil "string Class~%float64 probability~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%float32 X~%float32 Y~%float32 Z~%bool Invalid~%~%~%"))
